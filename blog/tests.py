...
from jungblog.utils import get_current_site, get_sha256
...
class ArticleTest(TestCase):
    ...
    def test_validate_article(self):
        ...
        self.assertEqual(response.status_code, 200)
        from jungblog.spider_notify import SpiderNotify
        ...
        p = Paginator(
            Article.objects.filter(
                author__username='juestnow'), 2)
        self.__check_pagination__(p, '作者文章归档', 'juestnow')
        ...
        u = gravatar_url('juestnow@gmail.com')
        u = gravatar('juestnow@gmail.com')

        link = Links(
            sequence=1,
            name="tycng",
            link='https://www.tycng.com')
        link.save()
    ...
    def test_image(self):
        ...
        os.remove(imagepath)
        from jungblog.utils import save_user_avatar, send_email
